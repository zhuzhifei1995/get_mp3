function () {
    return function () {
        ...
        (function () {
            ...
            h.a = function (b, c, g) {
                for (var e = Array(arguments.length - 2), k = 2; k < arguments.length; k++) e[k - 2] = arguments[k];
                return a.prototype[c].apply(b, e)
            }
        })();
        var m = "unknown error", l = {15: "element not selectable", 11: "element not visible"};
        l[31] = m;
        l[30] = m;
        ...
        function V(a, b) {
            ...
            g = ja[b] || b;
            a:if (f(U)) c = f(c) && 1 == c.length ? U.indexOf(c, 0) : -1; else {
                for (var u = 0; u < U.length; u++) if (u in U && U[u] === c) {
                    c = u;
                    break a
                }
                c = -1
            ...
            (c = null == k) || (c = typeof k, c = "object" == c && null != k || "function" == c);
            c ? e = Q(a, b) : e = k;
